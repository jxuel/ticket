...
$jscomp.polyfill("Promise", function(a) {
    ...
    f.race = function(a) {
        return new f(function(b, d) {
            for (var c = $jscomp.makeIterator(a), l = c.next(); !l.done; l = c.next())
...
$jscomp.polyfill("Map", function(a) {
    ...
    var f = function(a, b) {
        var c = b && typeof b;
        "object" == c || "function" == c ? e.has(b) ? c = e.get(b) : (c = "" + ++n,
        e.set(b, c)) : c = "p_" + b;
        var d = a.data_[c];
...
$jscomp.polyfill("Reflect.get", function(a) {
    return a ? a : function(a, e, g) {
        ...
        if (b)
            return b.get ? b.get.call(g) : b.value
    }
}, "es6", "es5");
...
$jscomp.polyfill("Reflect.set", function(a) {
    return a ? a : function(a, e, g, f) {
        var b = $jscomp.findDescriptor(a, e);
        return b ? b.set ? (b.set.call(3 < arguments.length ? f : a, g),
        !0) : b.writable && !Object.isFrozen(a) ? (a[e] = g,
        !0) : !1 : Reflect.isExtensible(a) ? (a[e] = g,
        !0) : !1
    }
}, "es6", "es5");
...
try {
    (function() {
        if ("undefined" !== typeof window)
            ...
            throw Error("cannot export Go (neither window nor self is defined)");
        var a = "";
        global.fs = {
            constants: {
                O_WRONLY: -1,
        ...
        global.Go = function() {
            ...
            var c = function() {
              ...
              , d = function(b, d) {
                if ("number" === typeof d)
                    isNaN(d) ? (c().setUint32(b + 4, 2146959360, !0),
                    c().setUint32(b, 0, !0)) : 0 === d ? (c().setUint32(b + 4, 2146959360, !0),
                    c().setUint32(b, 1, !0)) : c().setFloat64(b, d, !0);
                else {
                    switch (d) {
                    case void 0:
                        c().setFloat64(b, 0, !0);
        ...
        global.Go.prototype.run = function(a) {
            ...
            return $jscomp.asyncExecutePromiseGeneratorProgram(function(c) {
                1 == c.nextAddress && (b._inst = a,
                b._values = [NaN, 0, null, !0, !1, global, b._inst.exports.memory, b],
                b._refs = new Map,
        ...
        WebAssembly.instantiateStreaming || (WebAssembly.instantiateStreaming = function(a, b) {
            ...
            return $jscomp.asyncExecutePromiseGeneratorProgram(function(d) {
                ...
                case 2:
                    return c = d.yieldResult,
                    d.yield(WebAssembly.instantiate(c, b), 4);
                case 4:
